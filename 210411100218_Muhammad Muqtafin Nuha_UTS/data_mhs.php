...
$sql_tbl = "SELECT * FROM tbl_mhs m, tbl_prodi p WHERE m.id_prodi = p.id_prodi ORDER BY id_mhs ASC";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#ModalEdit<?= $row["id_mhs"]; ?>">
                                Edit
                            </button>
                            <button type="button" class="btn btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#ModalDelete<?= $row["id_mhs"]; ?>">
                                Delete
                            </button>
                        </td>
                    </tr>
